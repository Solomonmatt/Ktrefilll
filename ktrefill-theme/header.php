        ...
        <nav class="site-nav" aria-label="Primary navigation">
            ...
            wp_nav_menu(array(
                ...
                'fallback_cb' => function() {
                    echo '<ul>';
                    echo '<li><a href="' . esc_url(home_url('/dashboard.html')) . '">Dashboard</a></li>';
                    echo '<li><a href="' . esc_url(home_url('/buy-airtime.html')) . '">Buy Airtime</a></li>';
                    echo '<li><a href="' . esc_url(home_url('/buy-gift-card.html')) . '">Buy GiftCard</a></li>';
                    echo '<li><a href="' . esc_url(home_url('/physical-sim.html')) . '">Physical sim card</a></li>';
                    echo '<li><a href="' . esc_url(home_url('/carrier-esim.html')) . '">Carrier ESIM</a></li>';
                   
                    echo '<li><a href="' . esc_url(home_url('/order-tracking.html')) . '">Order Tracking</a></li>';
